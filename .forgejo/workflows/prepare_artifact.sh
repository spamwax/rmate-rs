...
create_linux() {
    ...
    elif [[ $TARGET == "x86_64-unknown-linux-gnu" || $TARGET == "i686-unknown-linux-gnu" || $TARGET == "x86_64-unknown-illumos" || $TARGET == "x86_64-unknown-freebsd" || $TARGET == "i686-unknown-freebsd" ]]; then
